...
// Adding a case below reports CS8509 at every switch that has not handled it; promote that
// warning to an error (<WarningsAsErrors>$(WarningsAsErrors);CS8509</WarningsAsErrors>) so it
// fails the build rather than falling through at runtime. An `abstract record` base cannot give
// you this, since any assembly can derive from it.
