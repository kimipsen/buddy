...
public static class ListMealPlanEndpoint
{
    ...
    {
        mealplans.MapGet("/children/{childId:guid}/plan", async Task<Results<Ok<IReadOnlyCollection<MealPlanEntry>>, NotFound, BadRequest<ErrorEnvelope>>> (
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            return result switch
            {
                ...
                Result<IReadOnlyCollection<MealPlanEntry>>.Validation(var problem) => TypedResults.BadRequest(problem.ToEnvelope(httpContext)),
