...
- Target .NET 10 compatibility (note likely changes for .NET 11 in the future) and EF Core with Npgsql provider for PostgreSQL 19.
...
Capabilities:
- Generate .NET 10 code for domain models, value types, event-sourced aggregates, event store adapters, and EF Core DbContexts mapped to a domain-specific schema.
